...
# --- Configuration ---
# CORRECTED PATH: The volume is mounted to /data, not /app/data.
...
def log_current_totp():
    ...
    try:
        # Check the corrected path for the seed file
    ...
    try:
        ...
        # Base32 encode the bytes (required format for pyotp secret)
